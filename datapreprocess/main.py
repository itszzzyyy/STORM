...
def main():
    ...
    if arg_processor.process_test:
        ...
        dataset_mode = arg_processor.dataset_mode
        q_start_ID = num_q
        [q, qdb, qraw, qdbraw,new_db,new_db_raw] = test_processor.process_data(num_q,dataset_mode,
                                                             min_traj_len, 
                                                             max_traj_len, 
                                                             drop_rate, 
                                                             s_distort, 
        ...
        db_start_ID = q[-1][0] + 1
        [db, _, dbraw, _,_,_] = test_processor.process_data(num_db, dataset_mode,
                                                        min_traj_len, 
        ...
        writer.write_test_data_split(q, qdb, db,new_db, qraw, qdbraw, dbraw,new_db_raw, num_q,
                                     arg_processor.nums_db, test_q_name,
                                     test_db_name, output_directory, lines_read)
