...
class FileWriter():
    ...
    def write_test_data_split(self, data_q, data_qdb, data_db, new_db, data_qraw,
                              data_qdbraw, data_dbraw, new_db_raw, num_q, nums_db,
        ...
        for i in range(len(nums_db)):
            ...
            data_qdb_db = np.concatenate((data_qdb_db, new_db))
            ...
            data_qdb_db_raw = np.concatenate((data_qdb_db_raw,new_db_raw))
